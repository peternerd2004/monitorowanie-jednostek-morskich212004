...
public class Track {
    ...
    private pl.koty.monitorowaniejednostekmorskich21.model.Geometry geometry;
    ...
    @JsonProperty("geometry")
    public pl.koty.monitorowaniejednostekmorskich21.model.Geometry getGeometry() {
        return geometry;
    }

    @JsonProperty("geometry")
    public void setGeometry(pl.koty.monitorowaniejednostekmorskich21.model.Geometry geometry) {
